...
const NewAppointmentForm: React.FC<NewAppointmentFormProps> = ({ isOpen, onClose, selectedDate }) => {
  const [formData, setFormData] = useState<FormData>({
    clientName: 'John Smith', // Pre-filled and read-only
    provider: '',
...
const handleSubmit = async (e: React.FormEvent) => {
  ...
  try {
    ...
    const title = `${formData.serviceType || 'Appointment'} with ${formData.provider}`;
